...
ffmpeg -i udp://localhost:5000 -c:v libx264 -preset veryfast -c:a aac -ac 2 -hls_flags delete_segments -hls_start_number_source epoch -f hls /var/www/html/stream/tv.m3u8
