...
ffmpeg -err_detect ignore_err -listen 1 -i tcp://0.0.0.0:5000 -c:v libx265 -preset fast -c:a aac -ac 2 -f mp4 -movflags frag_keyframe+empty_moov - | ffmpeg -err_detect ignore_err -i pipe: \
