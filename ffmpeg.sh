...
socat -T 30 TCP-LISTEN:5000,fork,max-children=2 - \
| ffmpeg -err_detect ignore_err -i pipe: -c:v libsvtav1 -g 60 -preset 11 -c:a aac -ac 2 -f mp4 -movflags frag_keyframe+empty_moov - \
