...
ffmpeg -err_detect ignore_err -listen 1 -i tcp://0.0.0.0:5000 -c:v libx264 -preset medium -crf 23 -x264-params keyint=60 -c:a aac -ac 2 -f mpegts - | ffmpeg -err_detect ignore_err -i pipe: \
-c copy -f hls -hls_time 2 -hls_list_size 1000 -hls_start_number_source epoch -hls_flags delete_segments -hls_segment_type mpegts /tmp/hls/tv.m3u8 \
