...
| ffmpeg -err_detect ignore_err -i pipe: -filter:v fps=30 -c:v libx264 -preset veryfast -g 60 -keyint_min 60 -c:a aac -ac 2 -c:s mov_text -f mp4 -movflags frag_keyframe+empty_moov+dash - \
