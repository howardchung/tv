...
-c copy -f dash -adaptation_sets "id=0,descriptor=<Accessibility schemeIdURI=\"urn:scte:dash:cc:cea-618:2015\" value=\"CC1=eng\"/>,streams=v id=1,streams=a" -window_size 2000 -frag_duration 2 /var/www/dash/tv.mpd \
