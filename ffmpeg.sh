...
-c copy -f dash -adaptation_sets "id=0,descriptor=PEFjY2Vzc2liaWxpdHkgc2NoZW1lSWRVUkk9InVybjpzY3RlOmRhc2g6Y2M6Y2VhLTYxODoyMDE1IiB2YWx1ZT0iQ0MxPWVuZyIvPg==,streams=v id=1,streams=a" -window_size 2000 -frag_duration 2 /var/www/dash/tv.mpd \
