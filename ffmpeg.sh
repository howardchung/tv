...
| ffmpeg -err_detect ignore_err -i pipe: -c:v libx265 -preset veryfast -x265-params "keyint=60:min-keyint=60" -c:a aac -ac 2 -f mp4 -movflags frag_keyframe+empty_moov - \
