...
nc -l 5000 | ffmpeg -i pipe: -c:v libx264 -preset medium -g 60 -keyint_min 60 -c:a aac -ac 2 -c:s mov_text -f mp4 -movflags empty_moov+frag_keyframe - | ffmpeg -err_detect ignore_err -i pipe: \
