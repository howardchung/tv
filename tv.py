...
def launch(id):
    ...
    if not id:
        return
    #-vf scale=-1:720
    encode = '-vaapi_device /dev/dri/renderD128 -vf \'format=nv12,hwupload\' -c:v h264_vaapi -sei -a53_cc -g 60 -b:v 4M'
    ...
    container_hls = '-f hls -hls_time 8 -hls_list_size 2700 -hls_flags delete_segments'
    container_dash = '-tag:v av01 -tag:a mp4a -f dash -seg_duration 8 -window_size 2700'
    container3 = '-f flv'
